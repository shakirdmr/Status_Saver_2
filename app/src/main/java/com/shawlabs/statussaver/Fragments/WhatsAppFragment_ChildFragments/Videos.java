...
public class Videos extends Fragment {
    ...
    Button whatsAppSend;
    private MyAsyncTask_Videos_NORMAL mAsyncTask;
    RecyclerView mRecyclerView;
    FilesGrabberAdapter mDocumentFileAdapter;
    SwipeRefreshLayout swipeRefreshLayout;
    LinearLayout nothingFound_directMessageBox_vid;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nothingFound_directMessageBox_vid = view.findViewById(R.id.nothingFound_directMessageBox_videos);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                {
                    mAsyncTask = new MyAsyncTask_Videos_NORMAL();
                    mAsyncTask.execute();
                }
    ...
    private class MyAsyncTask_Videos_NORMAL extends AsyncTask<Void, List<satusModal>, Void> {
        ...
        protected void onPostExecute(Void unused) {
            ...
            if(list_of_files.size()<1) {
                nothingFound_directMessageBox_vid.setVisibility(View.VISIBLE);
                ...
                nothingFound_directMessageBox_vid.setVisibility(View.GONE);
        }
    }
